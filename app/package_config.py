...
PACKAGES: dict[str, PackageDefinition] = {
    "foundation": PackageDefinition(
        ...
        legacy_tier="Basic",
        tagline="Portfolio website and deployment.",
    ...
    "launch": PackageDefinition(
        ...
        tagline="Portfolio, resume optimization, and LinkedIn alignment.",
    ...
    "accelerator": PackageDefinition(
        ...
        legacy_tier="Premium",
        tagline="Full positioning with strategy session and career narrative.",
